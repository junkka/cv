...
\textsc{url}: $info.url$\\ % Your academic/personal website
...
%   ($references.issued$) “$references.title$" \emph{$references.container-title$}\\
% $endif$
% $endfor$
...
$for(talks)$
\years{$talks.year$} “$talks.title$“, \emph{$talks.event$}, $talks.place$\\
$endfor$
