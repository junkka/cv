...
$if(references.URL)$ \\\url{http://johanjunkka.com/cv/$references.URL$}\\ $endif$
$endif$
$endfor$
...
$for(other)$
\years{$other.from$-$other.to$}\textsc{$other.title$} $if(other.university)$$other.university$$endif$
